...
class TwitterFollowerManager(models.Manager):
    """
    """
...
class TwitterFollower(models.Model):
    ...
    objects = TwitterFollowerManager()
    ...
    def __str__(self):
        # Note use of django.utils.encoding.force_bytes() here because
        # first_name and last_name will be unicode strings.
        return force_bytes('TwitterFollower - %s' % self.screen_name)


class TwitterFollowingManager(models.Manager):
    """
    """
...
class TwitterFollowing(models.Model):
    ...
    objects = TwitterFollowingManager()
    ...
    def __str__(self):
        # Note use of django.utils.encoding.force_bytes() here because
        # first_name and last_name will be unicode strings.
        return force_bytes('TwitterFollowing - %s' % self.screen_name)